    ...
    var body: some View {
        ZStack {
            Rectangle()
                ...
                .blur(radius: contentHasScrolled ? 35 : 0)
                .opacity(contentHasScrolled ? 0.3 : 0)
            
            Text(title)
                .animatableFont(size: contentHasScrolled ? 16 : 22, weight: .medium)
                .foregroundStyle(contentHasScrolled ? .white: .white)
                .frame(maxWidth: .infinity, maxHeight: .infinity, alignment: .topLeading)
                .padding(.horizontal, 20)
                .padding(.top, contentHasScrolled ? 20 : 10)
        ...
        .offset(y: contentHasScrolled ? -14 : 0)
    }
